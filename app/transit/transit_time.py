...
class TransitCalculator:
    ...
    def __init__(self, shared_routes):
        # create db session
    ...
    def set_current_routes(self) -> None:
        self.current_routes = set((a, b) for route in self.shared_routes for a, b in [route, route[::-1]])
    ...
    def process_mac_records_mode1(self, current_time: datetime, records: List[TemporaryTransitEntry]) -> Optional[datetime]:
        ...
        return current_start.timestamp
